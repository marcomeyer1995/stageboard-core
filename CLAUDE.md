...
*   **[docs/03_Developer_Experience.md](docs/03_Developer_Experience.md)** — Logging-Strategie, Testing/Hardware-Mocks, geplanter interner MCP-Server, Issue-Driven Workflow. → lesen bei Fragen zu Tests, Observability oder dem KI-Entwicklungsworkflow selbst.
