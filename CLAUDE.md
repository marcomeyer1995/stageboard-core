...
*   **[docs/03_Developer_Experience.md](docs/03_Developer_Experience.md)** — Node.js-Version via nvm (siehe oben), Logging-Strategie, Testing/Hardware-Mocks, geplanter interner MCP-Server, Issue-Driven Workflow. → lesen bei Fragen zu Tests, Observability, Dependency-Versionen oder dem KI-Entwicklungsworkflow selbst.
